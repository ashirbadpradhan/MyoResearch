...
% labels = [1 1 1, 2 2 2]';
a = prdataset(data,genlab([11 9 10]));
b = prdataset(data2,genlab([10 10 11]));
d = prdataset(data3,genlab([11 11 8]));
...
train = setlablist(train,char('left','right','open'));
...
test = setlablist(test,char('left','right','open'));
