...
dlmwrite('features8_train_right_50.csv',featurevec,'-append');
...
dlmwrite('features4_train_right_50.csv',featurevec,'-append');
featurevec=[meanval(x(1):x(2),[3 7]) rmsval(x(1):x(2),[3 7]) varval(x(1):x(2),[3 7]) waveformlength(x(1):x(2),[3 7]) zc(x(1):x(2),[3 7])];
dlmwrite('features2_train_right_50.csv',featurevec,'-append');
