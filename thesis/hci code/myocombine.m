...
featurevec8=[meanval(x(1):x(2),:) rmsval(x(1):x(2),:) varval(x(1):x(2),:) waveformlength(x(1):x(2),:) zc(x(1):x(2),:)];
dlmwrite('features8_trainno.csv',featurevec8,'-append');
